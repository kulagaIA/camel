...
The camel.server supports 16 options, which are listed below.

[width="100%",cols="2,5,^1,2",options="header"]
|===
| Name | Description | Default | Type
| *camel.server.authentication* | setAuthentication |  | HttpServerAuthenticationConfigurationProperties
...
| *camel.server.testValue* | Whether to enable testValue | false | boolean
